...
RUN apk --no-cache add curl gcc git libxml2-dev libxslt-dev musl-dev pip
...
RUN pip install --user --no-cache-dir --no-warn-script-location https://github.com/omergorur/streamlink/archive/refs/heads/master.zip && \
